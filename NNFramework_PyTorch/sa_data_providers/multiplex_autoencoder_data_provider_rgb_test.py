...
class MultiplexAutoencoderDataProviderRGBTest(AbstractDataProvider):
    ...
    def get_next_one(self):
        ...
        self.batch_filenames.append(self.img_id)
        data_point = self.load_image(self.img_id, do_match_size=(not self.do_preprocess and not self.do_postprocess and self.input_img_height > 0));
    ...
    def get_next_n(self, n:int):
        ...
        return data_points, labels, self.batch_filenames;
